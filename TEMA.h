...
/*
УЛЬТРА КАНАЛЫ СОБЫТИЙ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
ДЕЛАЕМ КАНАЛ СОБЫТИЙ НА КАЖДЫЙ ПОПУЛЯРНЫЙ КЛАСС
КЛАСС УРОВНЯ СОДЕРЖИТ В СЕБЕ ВСЕ КАНАЛЫ СОБЫТИЙ
КАНАЛЫ СОБЫТИЙ УПРАВЛЯЮТ ВСЕМИ ПОЛЯМИ В КЛАССЕ -> КАЖДЫЙ ПОПУЛЯРНЫЙ КЛАСС ИМЕЕТ МЕТОД РЕАКЦИИ НА СОБЫТИЕ КАНАЛА.
добавить гофрошку!!!!
*/